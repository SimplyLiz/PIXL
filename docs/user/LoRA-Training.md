...
- **Input:** "a 16x16 wall tile, dark fantasy theme, dense layout"
- **Output:** the actual PAX character grid from your tileset
...
All training happens locally. Your tiles, your model weights, your machine. Nothing is uploaded to any cloud service.
