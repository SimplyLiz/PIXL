...
<Callout type="warn">DALL-E generation requires an `OPENAI_API_KEY` environment variable. Stable Diffusion and Midjourney images can be imported without an API key using `pixl convert`.</Callout>
